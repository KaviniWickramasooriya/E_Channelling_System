		...
		<div class="row">
			...
			<div class="col-md-6 offset-md-3">
				<div class="card paint-card">
					<div class="card-body">
						<p class="text-center fs-4">Add Record</p>
						...
						%>
						<form class="row" action="../updateRecord" method="post">
							<div class="col-md-6">
							...
							<div class="col-md-12">
								...
								<textarea required name="disc" class="form-control" row="3"
									cols=""></textarea>
							</div>
							...
							<button class=" mt-3 btn btn-primary col-md-6 offset-md-3">Add Record</button>
